...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do SolutionsZAP que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Instalador - Solutions , Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar SolutionsZAP\n"
  printf "   [1] Atualizar SolutionsZAP\n"
  printf "   [2] Deletar SolutionsZAP\n"
  printf "   [3] Bloquear SolutionsZAP\n"
  printf "   [4] Desbloquear SolutionsZAP\n"
  printf "   [5] Alter. dominio SolutionsZAP\n"
  printf "\n"
  read -p "> " option
